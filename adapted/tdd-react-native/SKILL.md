...
## Bare React Native (Expo değil)

Bare RN'de jest preset `react-native`, native modül mock'ları zorunlu (Expo'da otomatik), Maestro `appId` android build.gradle'dan alır.

Tam setup + native mock şablonları → **[examples/03-bare-rn-setup.md](examples/03-bare-rn-setup.md)**
